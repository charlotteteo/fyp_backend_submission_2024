...
async def retrieve_user_description(user_id: str):
    ...
    f""" please evaluate the user below: {user}, according to the schwabb test {risk} against 100 for each is as such. Please describe overall risk aversion and risk willingness to user """
                   ,chat_history = [])
